...
module ciBackend 'demo2-ci/containerInstanceSidecar.bicep' = {
  ...
  params: {
    ...
    containerImageMain: 'daniellindemann/beer-rating-backend:10'
    containerPortMain: 5178
    containerImageSidecar: 'daniellindemann/beer-rating-console-beerquotes:10'
...
module ciFrontend 'demo2-ci/containerInstance.bicep' = {
  ...
  params: {
    ...
    logAnalyticsWorkspaceName: logAnalyticsWorkspace.outputs.name
    containerImageMain: 'daniellindemann/beer-rating-frontend:10'

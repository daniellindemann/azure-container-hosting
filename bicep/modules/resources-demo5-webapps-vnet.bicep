...
module appServiceBackend 'demo5-webapps-vnet/appServiceSiteContainers.bicep' = {
  ...
  params: {
    ...
    containerImage: 'daniellindemann/beer-rating-backend:10'
    targetPortMainContainer: '5178'
    sideCarImage: 'daniellindemann/beer-rating-console-beerquotes:10'
    appSettings: {
      WEBSITES_PORT: '5178'
...
module appServiceFrontend 'demo5-webapps-vnet/appService.bicep' = {
  ...
  params: {
    ...
    managedIdentity: managedIdentity
    acrLoginServer: acrLoginServer
    containerImage: 'daniellindemann/beer-rating-frontend:10'
    appSettings: {
      WEBSITES_PORT: '5179'

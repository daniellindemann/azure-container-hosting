...
resource acrPullImagesRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(acr.id, managedIdentityKubeletPrincipalId, acrPullRole)
  scope: acr
  properties: {
    principalId: managedIdentityKubeletPrincipalId
...
resource keyVaultSecretUserRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(keyVault.id, managedIdentityKeyVaultSecretsProviderPrincipalId, keyVaultSecretUserRole)
  scope: keyVault
  properties: {
    principalId: managedIdentityKeyVaultSecretsProviderPrincipalId
